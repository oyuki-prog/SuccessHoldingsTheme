...
<main class="l-main">
  <div class="c-top">
    <div class="l-container">
      <h1 class="c-top__title">PRIVACY-POLICY</h1>
    </div>
    <p class="c-top__backText">PRIVACY-POLICY</p>
  </div>
  <div class="l-container">
    <p>株式会社サクセスストーリー（以下、「当サイト」と言います。）では、お客様からお預かりする個人情報の重要性を強く認識しており、個人情報の保護に関する法律、その他の関係法令を遵守すると共に、以下に定めるプライバシーポリシーに従って、個人情報を安全かつ適切に取り扱うことを宣言します。</p>
    <ul>
      <li>
        <h2>１．個人情報の定義</h2>
      ...
      <li>
        <h2>５．個人情報の開示・訂正・削除について</h2>
        <p>お客様からお預かりした個人情報の確認、訂正・削除等をご希望の場合、お客様ご本人が当サイトのお問い合わせフォームよりお申し出ください。</p>
        <p>適切な本人確認を行った後、速やかに対応いたします。</p>
      </li>
      <li>
        <h2>６．当サイトへのコメントについて</h2>
      ...
      <li>
        ...
        <p>なお、トラフィックデータからお客様個人を特定することはできません。詳しくは<a rel="noreferrer noopener" target="_blank" href="https://marketingplatform.google.com/about/analytics/terms/jp/">Googleアナリティクス利用規約</a>をご確認ください。</p>
      </li>
      <li>
        <h2>８．Cookie（クッキー）について</h2>
      ...
      <li>
        ...
        <h2>Googleアドセンスについて</h2>
        <p>Googleアドセンスによる広告配信プロセスの詳細や、Cookieを用いた情報が広告配信事業者に使用されないようにする方法については、<a rel="noreferrer noopener" href="https://adssettings.google.com/authenticated" target="_blank">Google広告設定</a>から、Cookieを使用したパーソナライズ広告を無効にできます。</p>
      </li>
      <li>
        <h2>１０．免責事項</h2>
  ...
  <a href="https://success-story.co.jp/contact" class="p-contact">
  <div class="l-container p-contact__inner">
    <h2 class="p-contact__heading">CONTACT</h2>
    <p class="p-contact__subHeading">お問い合わせ</p>
    <p class="p-contact__text">ご相談・お問い合わせはこちら</p>
    <div class="c-link__arrow c-link__arrow--white p-contact__arrow">></div>
  </div>
</a>
</main>
<?php get_footer(); ?>